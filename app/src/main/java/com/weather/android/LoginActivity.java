        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(username)&&!TextUtils.isEmpty(password)){
                    MyHelper myHelper = new MyHelper(LoginActivity.this,"information",null,1);
                    ...
                    if (cursor1.moveToNext()){
                        ...
                        Toast.makeText(LoginActivity.this,"抱歉，此用户不存在!",Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(LoginActivity.this,"用户名、密码都不能为空!",Toast.LENGTH_SHORT).show();
                }
            }
        });
        //点击注册按钮，跳转到注册界面

...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText editText1,editText2,editText3,mEtRegisteractivityPhonecodes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //判断用户名、密码、确认密码是否为空
                if(!TextUtils.isEmpty(username)&&!TextUtils.isEmpty(password)&&!TextUtils.isEmpty(rePassword)&&!TextUtils.isEmpty(phoneCode)) {
